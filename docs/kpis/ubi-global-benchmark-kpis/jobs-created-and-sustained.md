...
- Enables consistent and universal measurement across programs.
- Supported by a strong field-wide consensus on its importance.
- Serves as a reliable proxy for long-term sustainability and economic growth.

## Limitations

- Relevance varies across program types and can be more significant for public and university programs because of their societal and policy-driven mandates.
- For private or corporate programs, job creation tends to be a secondary outcome rather than a primary objective, even if it remains a valuable positive externality.
